...
| P0 validation (S00 output) | `p0_validation.json` (generated by `scripts/p0_validation.py`) |
| P0 gate report | `gates/P0_GATE_REPORT_V23_2.md` — human gate decision PENDING |
